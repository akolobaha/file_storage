...
func (x *FileUploadResponse) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *MultipleFile) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MultipleFile) ProtoMessage() {}

func (x *MultipleFile) ProtoReflect() protoreflect.Message {
	mi := &file_files_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MultipleFile.ProtoReflect.Descriptor instead.
func (*MultipleFile) Descriptor() ([]byte, []int) {
	return file_files_proto_rawDescGZIP(), []int{3}
}

func (x *MultipleFile) GetFiles() []*File {
	if x != nil {
		return x.Files
	}
	return nil
...
var file_files_proto_rawDesc = string([]byte{
	0x0a, 0x0b, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1f, 0x67,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x46, 0x0a,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x90, 0x01, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x12,
	...
	,
...
var file_files_proto_goTypes = []any{
	...
	(*File)(nil),                  // 2: File
	(*MultipleFile)(nil),          // 3: MultipleFile
	(*Empty)(nil),                 // 4: Empty
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_files_proto_depIdxs = []int32{
	5, // 0: File.created_at:type_name -> google.protobuf.Timestamp
	5, // 1: File.updated_at:type_name -> google.protobuf.Timestamp
	2, // 2: MultipleFile.files:type_name -> File
	0, // 3: FileService.UploadFile:input_type -> FileChunk
	4, // 4: FileListService.FilesList:input_type -> Empty
	1, // 5: FileService.UploadFile:output_type -> FileUploadResponse
	3, // 6: FileListService.FilesList:output_type -> MultipleFile
